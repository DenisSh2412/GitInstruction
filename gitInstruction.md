...
Для получения информации о состоянии репозитория вводится команда *git status*. При вводе этой команды возможно следующее:
...
*git clone <url-ссылка>* | создание копии удаленного репозитория
*git add* | добавление изменения
*git commit -m "Комментарий"* | сохранение изменения
*git status* | просмотр информации о состоянии репозитория
*git log* | просмотр истории изменений
*git log --graph* | просмотр истории изменений в виде графа
*git checkout <номер коммита или имя ветки>* | перемещение между коммитами или ветками
*git checkout master* | возвращение на основную ветку
*git diff* | просмотр изменений между последним сохраненным коммитом и исходной версией файла
*git branch* | просмотр всех веток в репозитории
*git branch <имя ветки>* | создание новой ветки
*git merge <имя ветки>* | слияние исходной ветки с основной веткой
*git branch -d <имя ветки>* | удаление ветки
*git branch -D <имя ветки>* | удаление ветки без сохранения изменений
*git push* | запись изменений в удаленный репозиторий
*git pull* | загрузка актуального состояния из удаленного репозитория
     

## **Заключение**
На сегодняшний день Git играет важную роль в совместной работе и по сути является must-have инструментом для взаимодействия нескольких разработчиков на одном проекте.
Таким образом, Git — абсолютный лидер по популярности среди современных систем управления версиями. Это развитый проект с активной поддержкой и открытым исходным кодом. Одним из главных преимуществ Git является то, что он показывает очень высокую производительность в сравнении со множеством альтернатив.

## **Дополнительная информация**

Мы познакомились с некоторыми командами Git. Для более подробной информации лучше обратиться к [документации](https://git-scm.com/doc). Также существуют различные сайты для тренировки навыков работы с Git:
* [Самоучитель](https://githowto.com/ru) по Git.
* [Тренажер](https://learngitbranching.js.org/?locale=ru_RU) для отработки навыков.

## **Полезные дополнительные команды**

* *git reset* позволяет убрать из индекса все добавленные в него изменения (в рабочей директории все изменения сохранятся), антипод git add

* *git log --since=3 months* позволяет показать коммиты за последние 3 месяца

* *git show <хэш>* позволяет показать изменения из коммита с указанным хешем

* *git tag <имя тега>* позволяет создать тег с указанным именем на коммите, на который указывает HEAD
